...
class BuyHistory:
    ...
    def run(self, current_page_num: int = 1) -> list[HistoryItem]:
        ...
        self.driver.get(f"https://buff.163.com/market/buy_order/history?game=csgo&page_num={current_page_num}")

        history_items = []

        # get maximum page num, class name list-pager and tag name li0 hh
        ...
        # convert to json
        # json_str = json.dumps([ob.__dict__ for ob in history_items])
        # return json_str
